...
print(f"Valor total do item -------------   R$ {round(valorTotalMorangos,2)}")
print(f"Maçã ----------------------------   {qdeMacas} kg")
print(f"Valor total do item -------------   R$ {round(valorTotalMacas, 2)}")
print(f"Quantidade total dos produtos ---   {qdeTotal} kg")
print(f"Valor dos produtos --------------   R$ {round(valorTotalParcial,2)}")
print(f"Valor a pagar -------------------   R$ {round(valorTotalFinal, 2)}")
print("===================================================")
